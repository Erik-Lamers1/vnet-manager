...
class TestEnableTypeSpecificMachineConfiguration(VNetTestCase):
    def setUp(self) -> None:
        self.configure_lxc_ip_forwarding = self.set_up_patch("vnet_manager.operations.machine.configure_lxc_ip_forwarding")
